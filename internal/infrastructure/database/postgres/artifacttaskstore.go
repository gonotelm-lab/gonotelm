...
var _ database.ArtifactTaskStore = &ArtifactTaskStoreImpl{}
...
func (a *ArtifactTaskStoreImpl) GetById(ctx context.Context, id database.Id) (*schema.ArtifactTask, error) {
...
func (a *ArtifactTaskStoreImpl) GetStatusById(ctx context.Context, id database.Id) (string, error) {
	var task schema.ArtifactTask
	if err := a.db.WithContext(ctx).
...
func (a *ArtifactTaskStoreImpl) DeleteByNotebookId(ctx context.Context, notebookId database.Id) error {
	if err := a.db.WithContext(ctx).
		Where("notebook_id = ?", notebookId).
...
func (a *ArtifactTaskStoreImpl) DeleteById(ctx context.Context, id database.Id) error {
	if err := a.db.WithContext(ctx).
		Where("id = ?", id).
		Delete(&schema.ArtifactTask{}).Error; err != nil {
		return sql.WrapErr(err)
