...
generateSubagentConcurrency = ${GONOTELM_STUDIO_VIDEOOVERVIEW_SUBAGENT_CONCURRENCY:-5}
generateSubagentMaxRound = ${GONOTELM_STUDIO_VIDEOOVERVIEW_SUBAGENT_MAX_ROUND:-40}
